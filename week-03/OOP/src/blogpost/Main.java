...
public class Main {
    public static void main(String[] args) {
        ...
        BlogPost post1 = new BlogPost("John Doe", "Loren Ipsum", "Lorem ipsum dolor sit" +
                " amet.", "2000.05.04.");
        BlogPost post2 = new BlogPost("Tim Urban", "Wait but why", "A popular long-form," +
                " stick-figure-illustrated blog about almost everything.", "2010.10.10.");

        BlogPost post3 = new BlogPost("William Turton", "One Engineer Is Trying to Get IBM to Reckon" +
