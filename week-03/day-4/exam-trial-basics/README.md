...
You can use method of class Math, Math.random(), which return
 random double between 0-1. By multiplying this number you can
 get random number in range you need. For example: 
 Math.random()*10 gives you doubles between 0-10.

### What is a ternary operator? How does it work?
ternary operator is used as a alternative solution for if-else
expression

we use it in this construction:
boolean Expression ? expression1 : expression2

and it means that if boolean Expression is true, output is
assigned to expression1, otherwise to expression2.
